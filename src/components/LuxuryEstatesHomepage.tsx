  ...
  return (
    ...
    >
      <main className="flex-grow flex flex-col h-full">
        {/* Hero Section */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 text-center flex-shrink-0">
        ...
        {/* Services Grid */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16 flex-grow flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
            {/* Buy Section */}
            <a className="group relative block overflow-hidden rounded-xl h-120 shadow-lg" href="#">
              <div 
              ...
              <div className="relative flex flex-col h-full justify-end p-8 text-white">
                ...
                <div className="mt-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 ease-in-out">
                  <p className="text-sm text-background-light/80">Explore premium listings</p>
            ...
            <a className="group relative block overflow-hidden rounded-xl h-120 shadow-lg" href="#">
              ...
              <div className="relative flex flex-col h-full justify-end p-8 text-white">
                ...
                <div className="mt-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 ease-in-out">
                  <p className="text-sm text-background-light/80">Find your ideal rental home</p>
                  <div className="mt-4 inline-flex items-center font-semibold text-primary">
            ...
            <a className="group relative block overflow-hidden rounded-xl h-120 shadow-lg" href="#">
              ...
              <div className="relative flex flex-col h-full justify-end p-8 text-white">
                ...
                <div className="mt-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 ease-in-out">
                  <p className="text-sm text-background-light/80">Invest in the future</p>
                  <div className="mt-4 inline-flex items-center font-semibold text-primary">
